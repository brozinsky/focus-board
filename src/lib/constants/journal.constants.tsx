export const JOURNAL_SHEETS = [
  { id: 1, name: "Lines", value: "lines" },
  { id: 2, name: "Grid", value: "grid" },
  { id: 3, name: "Bullet", value: "bullet" },
  { id: 4, name: "None", value: "none" },
];

export const JOURNAL_FONTS = [
  { id: 1, name: "Patrick hand", value: "font-patrick-hand" },
  { id: 2, name: "Shadows into light", value: "font-shadows-into-light" },
  { id: 3, name: "Indie flower", value: "font-indie-flower" },
];

export const JOURNAL_BG_COLORS = [
